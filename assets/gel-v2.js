class GelDrawer extends HTMLElement {
  constructor() {
    ...
    this.discountPercent = this.querySelector("[data-total-discount]");
  ...
  updateVariantPrice() {
    ...
    const discountPercent = this.querySelector(
    `[data-bundle-quantity="${this.currentBundle}"] [data-bundle-discount-percent]`
    );
    ...
    this.discountPercent.querySelector('span').innerHTML = discountPercent.innerHTML;
 }
